...
function showDivs(n) {
  ...
  x[slideIndex-1].style.display = "block";  
    ...
    <?php
        ...
        echo "<p><a  id= 'back' href='filter.php' class='btn btn-primary' role='button'>&laquo;Back</a></p>";
        echo "</form>";
        echo "<form action= 'favlist.php' method='POST'>";
        echo "<p><a  id= 'fav' href='favlist.php?postid=$post_id' class='btn btn-primary' role='button'>Add to Favorite</a></p>";
        echo "</form>";
        echo "</div>";
        echo "</div>";
