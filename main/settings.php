...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
       ...
       <?php 
            ...
            $sql = "SELECT * FROM Users as a, Posts as b WHERE (a.Email='$email' AND a.Email = b.Email) ORDER BY b.TimeStamp DESC";
            $rs = $conn->query($sql);
            ...
            $sql = "SELECT * FROM Users as a, Posts as b WHERE (a.Email='$email' AND a.Email = b.Email) ORDER BY b.TimeStamp DESC LIMIT $this_page_first_result, $results_per_page";
            $rs = $conn->query($sql);
            while ($row = $rs->fetch_assoc()) {
                ...
                $post_id = $row['Post_ID'];
                echo "<p><a href='settings_postdetails.php?postid=$post_id' class='btn btn-primary' role='button'>Edit</a></p>";
                echo "</div>";
                echo "</div>";
                echo "<hr color='#eee'>";
            }
            ...
            for($page = 1 ; $page <= $number_of_pages ; $page++ ){
                echo"<a class = 'page' href='settings.php?page=" . $page . "'>" . $page . "</a> ";
            }
            echo "</div>";
        $conn->close();
       ?>
